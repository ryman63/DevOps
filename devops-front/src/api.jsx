...
// В продакшене используем относительные пути, в dev - прокси
const api = axios.create({
  baseURL: import.meta.env.PROD ? 'http://158.160.116.159:30080' : 'http://158.160.116.159:30080'
});

// дальше ваши методы как были ...
// Контроллер машин
